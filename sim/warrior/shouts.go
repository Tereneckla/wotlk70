...
func (warrior *Warrior) makeShoutSpell() *core.Spell {
	battleShout := warrior.makeShoutSpellHelper(core.ActionID{SpellID: 2048}, warrior.NewAllyAuraArray(func(unit *core.Unit) *core.Aura {
	...
	commandingShout := warrior.makeShoutSpellHelper(core.ActionID{SpellID: 469}, warrior.NewAllyAuraArray(func(unit *core.Unit) *core.Aura {
