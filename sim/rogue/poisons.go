		...
		Dot: core.DotConfig{
			...
			OnSnapshot: func(_ *core.Simulation, target *core.Unit, dot *core.Dot, _ bool) {
				if stacks := dot.GetStacks(); stacks > 0 {
					dot.SnapshotBaseDamage = (51 + 0.027*dot.Spell.MeleeAttackPower()) * float64(stacks)
...
func (rogue *Rogue) makeInstantPoison(procSource PoisonProcSource) *core.Spell {
	...
	return rogue.RegisterSpell(core.SpellConfig{
		ActionID:    core.ActionID{SpellID: 26890, Tag: int32(procSource)},
		SpellSchool: core.SpellSchoolNature,
		ProcMask:    core.ProcMaskWeaponProc,
		...
		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			baseDamage := sim.Roll(161, 215) + 0.09*spell.MeleeAttackPower()
			if isShivProc {
...
func (rogue *Rogue) makeWoundPoison(procSource PoisonProcSource) *core.Spell {
	...
	return rogue.RegisterSpell(core.SpellConfig{
		ActionID:    core.ActionID{SpellID: 27188, Tag: int32(procSource)},
		SpellSchool: core.SpellSchoolNature,
		ProcMask:    core.ProcMaskWeaponProc,
		...
		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			baseDamage := 112 + 0.036*spell.MeleeAttackPower()
